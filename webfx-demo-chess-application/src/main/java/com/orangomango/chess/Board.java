...
public class Board{
	...
	public String playerA = "User" /*System.getProperty("user.name")*/, playerB = "BLACK";
	...
	public String getPGN(){
		...
		builder.append("[Event \"" + this.playerA + " vs " + this.playerB+"\"]\n");
		builder.append("[Site \"com.orangomango.chess\"]\n");
		builder.append("[Date \""+formatter.format(date)+"\"]\n");
	...
	public String getFEN(){
		...
		builder.append((this.enPassant == null ? "-" : this.enPassant) + " " + this.fifty + " " + this.movesN);
	...
	public String getBoardInfo(){
		...
		return "B:" + blackSum +
				" W:" + whiteSum +
				" - BK:" + (getAttackers(this.blackKing) != null) +
				" WK:" + (getAttackers(this.whiteKing) != null) +
				" - BCK:" + isCheckMate(Color.BLACK) +
				" WCK:" + isCheckMate(Color.WHITE) +
				"\nChecks: " + this.blackChecks + " " + this.whiteChecks +
				"\n";
	}
