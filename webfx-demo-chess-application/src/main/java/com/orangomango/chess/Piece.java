...
public class Piece{
	...
	public Piece(Pieces type, Color color, int x, int y){
		...
		this.x = x;
		this.y = y;
		this.image = new Image(Resource.toUrl("/images/"+type.name().toLowerCase()+"_"+(color == Color.WHITE ? "white" : "black")+".png", getClass()));
	}
	...
	public String toString(){
		return this.type.getName() + "(" + (this.color == Color.WHITE ? 0 : 1) + ")";
